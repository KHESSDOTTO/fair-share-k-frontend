...
export function BusinessNavBar() {
  ...
  return (
    <nav className="h-20 text-lg border-b border-green-400 flex flex-row items-center justify-evenly p-2 bg-green-400/70 mb-8 font-semibold text-green-900 shadow-xl">
      ...
      <Link to="/business/profile" className={NavBtnClass}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          fill="currentColor"
