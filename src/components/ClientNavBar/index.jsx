...
export function ClientNavBar() {
  ...
  return (
    <nav className="h-16 text-lg border-b border-green-400 flex flex-row items-center justify-evenly p-2 bg-green-400 mb-8 font-semibold text-green-900 shadow-xl">
