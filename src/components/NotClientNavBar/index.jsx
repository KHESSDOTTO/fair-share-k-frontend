...
export function NotClientNavBar() {
  ...
  return (
    <nav className="h-16 text-lg border-b border-green-400 flex flex-row items-center justify-evenly p-2 bg-green-300/30 font-semibold text-green-900 shadow-xl">
